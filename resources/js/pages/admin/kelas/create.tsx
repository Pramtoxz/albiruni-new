    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4 md:p-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">Tambahkan kelas baru</p>
                    </div>
                </div>
            ...
            <ConfirmDialog
                ...
                description={`Apakah Anda yakin ingin menyimpan kelas <strong>"${data.nama_kelas}"</strong>?<br /><br />Pastikan semua data yang diisi sudah benar.`}
