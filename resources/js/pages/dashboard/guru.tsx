                ...
                <div className="mt-8 space-y-5 px-4 relative z-10">
                    ...
                    <Link href="/guru/materi">
                        <Card className="border-0 shadow-xl rounded-3xl overflow-hidden bg-white hover:shadow-2xl transition-all cursor-pointer">
                            ...
                            <CardContent className="space-y-3 p-4">
                                <div className="flex gap-3 rounded-2xl bg-gradient-to-r from-green-50 to-teal-50 p-4 border-l-4 border-green-400">
                    ...
                    <Link href="/guru/tugas">
                        <Card className="border-0 shadow-xl rounded-3xl overflow-hidden bg-white hover:shadow-2xl transition-all cursor-pointer">
                            ...
                            <CardContent className="space-y-3 p-4">
                                <div className="flex items-center justify-between rounded-2xl bg-gradient-to-r from-red-50 to-orange-50 p-4 border-l-4 border-red-400">
