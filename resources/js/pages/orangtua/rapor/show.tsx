...
interface Rapor {
    id: number;
    siswa: {
        id: number; nama_lengkap: string; nama_panggilan: string;
        jenis_kelamin: string; tanggal_lahir: string;
...
interface WhoData {
    wfa: WhoZScorePoint[]; lhfa: WhoZScorePoint[]; hcfa: WhoZScorePoint[];
}
...
const STATUS_COLORS: Record<string, string> = {
    BB: 'bg-red-100 text-red-800', MB: 'bg-yellow-100 text-yellow-800',
            ...
            <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-pink-50 to-blue-50 pb-8 relative overflow-hidden">
                ...
                <div className="pt-12 pb-4 px-4 space-y-4 relative z-10">
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <span className="text-xs px-2.5 py-1 rounded-full font-semibold shrink-0 bg-green-100 text-green-800">
                            ✓ Final
                        </span>
                    </div>
